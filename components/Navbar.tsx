        ...
        <div className="flex justify-between items-center h-20">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
              <Image 
                ...
                width={50} 
                height={50}
                className="w-12 h-12 object-contain drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]"
              />
            </div>
            <span className="text-3xl font-black text-primary tracking-tighter style-stroke-sm leading-none">STAR BITES</span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 rounded-xl transition"
            >
              {isMenuOpen ? <X className="w-8 h-8 stroke-[3]" /> : <Menu className="w-8 h-8 stroke-[3]" />}
            </button>
          </div>
        </div>
